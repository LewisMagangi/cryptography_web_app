...
RESULTS_PATH = os.path.join(os.path.dirname(__file__), '..', 'data', 'results', 'asymmetric_analysis_results.csv')

class AsymmetricDataVisualization:
    def __init__(self):
        self.data = pd.read_csv(RESULTS_PATH)
        self.algorithms = ["RSA", "DSA", "DH", "ECC"]
        self.base_plot_dir = os.path.join(os.path.dirname(__file__), '..', 'media', 'plots', 'asymmetric_analysis')
...
if __name__ == "__main__":
    # Create AsymmetricDataVisualization instance
    visualizer = AsymmetricDataVisualization()
